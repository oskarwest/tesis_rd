...
una reducción de falsos positivos (de 6 a 5 casos) y de falsos negativos (de 5 a 4 casos),
...
es, sin embargo, absoluta: en la clase RDP (RD4), asociada a la neoformación vascular, el
...
(4 a 5 casos sobre aproximadamente 105 por clase), lo cual es relevante en un contexto de
