...
aprendizaje por transferencia con el dataset de Kaggle (35.121 imágenes en su
distribución multiclase) para entrenamiento y datasets externos (MESSIDOR-2, IDRiD,
FOSCAL) para validación. Un aspecto distintivo es
