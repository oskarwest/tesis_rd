...
Alrededor de 463 millones de adultos entre 20 y 79 años tienen DM en
...
microvascular específica de la DM que afecta a 1 de cada 3 personas
...
en clasificación binaria (con un intervalo de confianza bootstrap del 95\% para el área bajo la curva ROC, AUC-ROC, de 0.9636–0.9936)
...
% Según el ejemplo de tabla de contenido de la norma ICONTEC (ICONTEC_Plantilla.pdf),
% el espacio entre la INTRODUCCIÓN y el primer capítulo numerado debe ser sencillo
% (igual al de una sección dentro de un capítulo), no el espacio doble que se usa
% entre capítulos numerados consecutivos. Se cancela aquí el salto adicional que
% tocloft inserta antes de la siguiente entrada de capítulo en la tabla de contenido.
