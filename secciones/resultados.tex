...
Leve=1, Moderada=2, Severa=3, PDR=4) y sumando los errores de las cuatro arquitecturas
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{l Y Y Y Y}
		\toprule
		Configuración & Adyacentes & No adyacentes & Referible $\rightarrow$ No referible & Severa/PDR $\rightarrow$ Normal/Leve \\
		\midrule
...
relevante es aquel en el que un caso de RD referible (Moderada, Severa o PDR) se clasifica
...
de PDR —las etapas con mayor riesgo de pérdida visual— se clasifican directamente como
...
(casos Normales clasificados como Severa o PDR) son poco frecuentes en las cuatro
...
panel d), esta arquitectura colapsa hacia las clases Normal, Leve y PDR con los canales
