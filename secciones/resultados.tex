...
La Tabla~\ref{tab:confusion-multiclase-rgb} presenta las matrices de confusión de las
...
\begin{table}[H]
	...
	\label{tab:confusion-multiclase-rgb}
...
La Tabla~\ref{tab:confusion-multiclase-verde} repite este ejercicio utilizando
únicamente el canal verde como entrada; el lector puede comparar directamente esta
matriz contra la de la Tabla~\ref{tab:confusion-multiclase-rgb} para observar el efecto
...
\begin{table}[H]
	...
	\label{tab:confusion-multiclase-verde}
	\begin{tabularx}{\textwidth}{l Y Y Y Y r}
		\toprule
		& Normal & Leve & Moderada & Severa & PDR \\
		\midrule
...
La Tabla~\ref{tab:confusion-multiclase-azul} presenta el mismo ejercicio para el canal
...
\begin{table}[H]
	...
	\label{tab:confusion-multiclase-azul}
	\begin{tabularx}{\textwidth}{l Y Y Y Y r}
		\toprule
		& Normal & Leve & Moderada & Severa & PDR \\
		\midrule
...
Finalmente, la Tabla~\ref{tab:confusion-multiclase-rojo} presenta las matrices de
...
\begin{table}[H]
	...
	\label{tab:confusion-multiclase-rojo}
	\begin{tabularx}{\textwidth}{l Y Y Y Y r}
		\toprule
		& Normal & Leve & Moderada & Severa & PDR \\
		\midrule
