...
Moderada ni Severa (Tabla~\ref{tab:confusion-multiclase-azul}, subtabla d). En términos de
...
de las matrices de confusión ya presentadas (Tablas~\ref{tab:confusion-multiclase-rgb} a
\ref{tab:confusion-multiclase-rojo}), se observa que para la clase Severa el canal verde
