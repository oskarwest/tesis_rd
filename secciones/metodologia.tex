...
frente a las imágenes sin enfermedad (No RD), y construir después el conjunto de
entrenamiento extrayendo aleatoriamente, del dataset de Kaggle, 1,050 imágenes de la
clase No RD y 1,050 imágenes de la clase RD (estas últimas seleccionadas aleatoriamente
entre las cuatro categorías de severidad restantes). Esta construcción produce, por
diseño, una proporción 50:50 entre ambas clases, sin necesidad de aplicar sobremuestreo
ni submuestreo adicional. La construcción de los conjuntos de validación externa para
