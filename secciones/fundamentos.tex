...
\textbf{Capas GaussianNoise:} Como se describió en la subsección anterior, la inyección
de ruido gaussiano sobre las activaciones actúa también como regularizador, al exponer al
modelo a versiones ligeramente corruptas de las representaciones aprendidas. Esto resulta
especialmente pertinente en este trabajo porque simula la variabilidad propia de la
adquisición de imágenes de fondo de ojo en condiciones clínicas reales (ruido del sensor,
diferencias de iluminación o preprocesado), a la vez que mitiga el sobreajuste de las
capas de clasificación añadidas sobre los backbones preentrenados \myfootcite{zur2009noise}.
