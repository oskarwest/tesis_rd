...
diabética (clasificación binaria) como por su nivel de severidad, en una escala de 0 a 4
(clasificación multiclase). En el aprendizaje supervisado, el modelo se entrena
